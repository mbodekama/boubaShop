  ...
  <div class="card-body">
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-sm-auto mb-2 mb-sm-0">
        <h6 class="mb-0">Liste des produits bloqués </h6>
      </div>
                  ...
                  <div class="border rounded h-100 d-flex flex-column justify-content-between pb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between px-3">
                      ...
                      <div>
                       ...
                       <a class="btn btn-sm btn-falcon-default text-primary eyeProd" href="#!" data-toggle="tooltip" 
                       data-placement="top" id="{{$prd->id}}"><span class="far fa-eye"></span>
                       </a>
                       <a class="btn btn-sm btn-falcon-default text-danger delProd" href="#!" data-toggle="tooltip" 
                       data-placement="top"  id="{{$prd->id}}"><span class="fas fa-trash"></span>
                       </a>
