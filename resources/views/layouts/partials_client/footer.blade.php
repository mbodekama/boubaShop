                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <div class="section-title-3">
                            ...
                            <p>Restez informer de nos périodes de solde</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="footer-widget mb-40">
                                <h3 class="footer-title">Catégorie</h3>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="footer-widget ml-70 mb-40">
                                <h3 class="footer-title">Lien du site</h3>
                                ...
                                <div class="contact-info-2">
                                    <div class="single-contact-info-2">
                                        ...
                                        <div class="contact-info-2-content">
                                            ...
                                            <h4 class="orange">(225) 0777718083</h4>
                                        </div>
                                    </div>
                                    <div class="single-contact-info-2">
                                        <div class="contact-info-2-icon">
                    ...
                    <div class="row flex-row-reverse">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="copyright copyright-center">
                                <p>Copyright © <?=date('Y')?>  #mbodev | <a href="https://hasthemes.com/">Designed and built  <span>by UNSITEPRO</span></a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-5 col-md-6 col-12 col-sm-12">
                                <div class="tab-content quickview-big-img">
                                    <div id="pro-1" class="tab-pane fade show active">
                                        <img src="{{ asset('assets/images/product/product-1.jpg') }}" alt="">
                                    </div>
                                    <div id="pro-2" class="tab-pane fade">
                                        <img src="{{ asset('assets/images/product/product-3.jpg') }}" alt="">
                                    </div>
                                    <div id="pro-3" class="tab-pane fade">
                                        <img src="{{ asset('assets/images/product/product-6.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="quickview-wrap mt-15">
                                    <div class="quickview-slide-active nav nav-style-6">
                                        ...
                                        <a data-bs-toggle="tab" href="#pro-4"><img src="{{ asset('assets/images/product/quickview-s2.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
